...
export const QA_ART: Record<string, Art> = {
  ...
  'why-did-my-group-health-renewal-go-up': localQaArt('why-did-my-group-health-renewal-go-up', 'Glass cost column ratcheted up a notch above last year\'s marker, why a group health renewal went up'),
  'how-do-you-apply-for-medicare-savings-programs-in-nevada': localQaArt('how-do-you-apply-for-medicare-savings-programs-in-nevada', 'A glass application slab moving along a brass conveyor through three lit checkpoints, how to apply for Medicare Savings Programs in Nevada'),
  'what-happens-to-health-insurance-during-a-casino-layoff': localQaArt('what-happens-to-health-insurance-during-a-casino-layoff', 'A tower of glass gaming chips going dark as a bridge of light builds toward a separate glowing dome, health insurance during a casino layoff'),
  'does-extra-help-cover-part-d-costs': localQaArt('does-extra-help-cover-part-d-costs', 'A brass arm lifting most of a stack of glowing cost blocks off a glass platform and leaving a small remainder, whether Extra Help covers Part D costs'),
  'how-long-do-you-have-after-a-qualifying-life-event': localQaArt('how-long-do-you-have-after-a-qualifying-life-event', 'A crystal and brass hourglass sealed in a vitrine ringed by a closing band of light, the deadline after a qualifying life event'),
  'what-is-the-qmb-program-in-nevada': localQaArt('what-is-the-qmb-program-in-nevada', 'A brass shield absorbing incoming glowing medical bills and leaving the surface behind it clear, the QMB program in Nevada'),
  'can-you-contribute-to-an-hsa-after-enrolling-in-medicare': localQaArt('can-you-contribute-to-an-hsa-after-enrolling-in-medicare', 'A brass valve sealing the inlet of a crystal reservoir that still holds its stored light, contributing to an HSA after enrolling in Medicare'),
  'can-gig-workers-deduct-health-insurance-premiums': localQaArt('can-gig-workers-deduct-health-insurance-premiums', 'One glowing line lifting out of a glass ledger and shortening the column of light above it, gig workers deducting health insurance premiums'),
  'is-employer-life-insurance-enough-for-a-family': localQaArt('is-employer-life-insurance-enough-for-a-family', 'A small glass shield covering only part of a family constellation with the outer lights left exposed, whether employer life insurance is enough'),
  'can-independent-contractors-get-group-health-rates': localQaArt('can-independent-contractors-get-group-health-rates', 'A single crystal node outside a brass-ringed group dome raising its own column of light, whether independent contractors can get group health rates'),
  'what-coverage-do-seasonal-construction-workers-need': localQaArt('what-coverage-do-seasonal-construction-workers-need', 'A crystal hard hat under a protective dome against an arc of light that swells and thins by season, coverage for seasonal construction workers'),
  'are-health-premiums-deductible-for-1099-contractors': localQaArt('are-health-premiums-deductible-for-1099-contractors', 'A glowing channel siphoning light out of an income column into a glass tax form, whether health premiums are deductible for 1099 contractors'),
  'what-does-medicare-part-d-cost-in-nevada': localQaArt('what-does-medicare-part-d-cost-in-nevada', 'Glowing capsules resting on four rising glass cost tiers with brass edges, what Medicare Part D costs in Nevada'),
  'does-losing-a-job-qualify-for-special-enrollment': localQaArt('does-losing-a-job-qualify-for-special-enrollment', 'A glass badge lifting off a brass wall as a doorway of light opens beside it, whether losing a job qualifies for special enrollment'),
  'can-you-keep-the-same-health-plan-next-year': localQaArt('can-you-keep-the-same-health-plan-next-year', 'Two nearly identical glass plan tablets with the next-year copy quietly rerouted inside, keeping the same health plan next year'),
  'when-should-a-small-business-start-shopping-its-renewal': localQaArt('when-should-a-small-business-start-shopping-its-renewal', 'A twelve-segment brass ring with a second marker lit three segments ahead of the deadline, when a small business should start shopping its renewal'),
  'is-workers-comp-the-same-as-health-insurance': localQaArt('is-workers-comp-the-same-as-health-insurance', 'Two glass shields on separate brass plinths lit by different light with a clear gap between them, whether workers comp is the same as health insurance'),
  'do-uber-and-doordash-drivers-get-health-insurance': localQaArt('do-uber-and-doordash-drivers-get-health-insurance', 'A glass car beside an empty brass benefits pedestal with a separate glowing shield further down the road, health insurance for Uber and DoorDash drivers'),
  'what-is-the-medicare-part-d-late-enrollment-penalty': localQaArt('what-is-the-medicare-part-d-late-enrollment-penalty', 'A glass capsule climbing a brass spiral and permanently gaining an amber ring at every turn, the Medicare Part D late enrollment penalty'),
  'does-medicare-cover-prescriptions-without-part-d': localQaArt('does-medicare-cover-prescriptions-without-part-d', 'A glass dome sheltering a few capsules while many more sit outside in shadow, whether Medicare covers prescriptions without Part D'),
  'when-can-you-preview-nevada-health-plans-for-next-year': localQaArt('when-can-you-preview-nevada-health-plans-for-next-year', 'A brass shutter lifting off a frosted pane as rows of glowing plan tiles come clear, when Nevada health plans can be previewed for next year'),
  'should-you-name-a-child-as-life-insurance-beneficiary': localQaArt('should-you-name-a-child-as-life-insurance-beneficiary', 'A payload of light held at a small crystal gate and redirected by a brass bracket toward a larger vault, naming a child as a life insurance beneficiary'),
  'does-moving-to-nevada-trigger-a-special-enrollment-period': localQaArt('does-moving-to-nevada-trigger-a-special-enrollment-period', 'A glass moving crate set down as a brass gate opens on a desert horizon, whether moving to Nevada triggers a special enrollment period'),
  'do-you-need-medicare-if-you-have-employer-insurance-at-65': localQaArt('do-you-need-medicare-if-you-have-employer-insurance-at-65', 'A large employer shield and a Medicare shield standing on the two branches of a brass fork, whether Medicare is needed with employer insurance at 65'),
  'can-part-time-hospitality-workers-get-marketplace-coverage': localQaArt('can-part-time-hospitality-workers-get-marketplace-coverage', 'A crystal service tray carrying a glowing dome through an open brass gate with no turnstile in the way, marketplace coverage for part-time hospitality workers'),
  'how-do-rideshare-drivers-estimate-income-for-subsidies': localQaArt('how-do-rideshare-drivers-estimate-income-for-subsidies', 'A jagged income waveform passing through a glass lens and leaving as one steady line beside a crystal car key, estimating rideshare income for subsidies'),
  'what-happens-if-a-driver-underestimates-income-for-subsidies': localQaArt('what-happens-if-a-driver-underestimates-income-for-subsidies', 'A crystal balance overfilled on one side while a brass counterweight swings back and spills glowing coins, underestimating income for health subsidies'),
  'is-union-health-coverage-better-than-marketplace-coverage': localQaArt('is-union-health-coverage-better-than-marketplace-coverage', 'A pooled glass dome and a lattice of individually lit nodes balanced on the same brass beam, union coverage compared with marketplace coverage'),
  'what-should-you-compare-when-window-shopping-health-plans': localQaArt('what-should-you-compare-when-window-shopping-health-plans', 'Four glass comparison panes on brass rails throwing beams that converge to one point, what to compare when window shopping health plans'),
  'what-happens-to-medicare-when-you-retire-after-65': localQaArt('what-happens-to-medicare-when-you-retire-after-65', 'A brass gate opening at the end of a glass corridor ringed by a tightening band of light, what happens to Medicare when you retire after 65'),
  'can-you-change-part-d-plans-every-year': localQaArt('can-you-change-part-d-plans-every-year', 'A brass carousel rotating glass capsules past one glowing annual gate, changing Medicare Part D plans each year'),
  'what-is-a-composite-rate-vs-age-banded-rate': localQaArt('what-is-a-composite-rate-vs-age-banded-rate', 'A single uniform glass bar beside a rising staircase of graduated bars carrying equal total light, composite rate compared with age-banded rate'),
  'is-cobra-considered-creditable-coverage-for-medicare': localQaArt('is-cobra-considered-creditable-coverage-for-medicare', 'A glass bridge stopping short of a brass gate with the gap glowing amber, whether COBRA counts as creditable coverage for Medicare'),
  'how-much-life-insurance-does-a-stay-at-home-parent-need': localQaArt('how-much-life-insurance-does-a-stay-at-home-parent-need', 'An empty glass figure weighed against a dense cluster of glowing service tokens on a brass scale, how much life insurance a stay-at-home parent needs'),
  'does-getting-married-change-health-insurance-options': localQaArt('does-getting-married-change-health-insurance-options', 'Two crystal rings fusing into a single aperture that opens new paths of light, how marriage changes health insurance options'),
  'can-a-business-change-group-plans-mid-year': localQaArt('can-a-business-change-group-plans-mid-year', 'A twelve-segment brass ring clasped shut with a single segment open and lit, whether a business can change group plans mid-year'),
  'what-documents-do-you-need-for-open-enrollment': localQaArt('what-documents-do-you-need-for-open-enrollment', 'A fan of glowing glass document slabs rising out of an open brass folder, the documents needed for open enrollment'),
  'does-tip-income-count-toward-health-insurance-subsidies': localQaArt('does-tip-income-count-toward-health-insurance-subsidies', 'Glowing tip coins merging with a wider stream of light in a crystal funnel and pouring into one ledger, whether tip income counts toward subsidies'),
  'when-should-parents-buy-life-insurance': localQaArt('when-should-parents-buy-life-insurance', 'A glass home under a protective dome on a brass timeline whose earliest segment burns brightest, when parents should buy life insurance'),
  'what-are-the-income-limits-for-medicare-savings-programs-in-nevada': localQaArt('what-are-the-income-limits-for-medicare-savings-programs-in-nevada', 'A rising pool of light held below a marked band on a crystal threshold gate, income limits for Medicare Savings Programs in Nevada'),
};
