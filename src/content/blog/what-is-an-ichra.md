---
title: "What Is An ICHRA? The Plain-English Guide For 2026"
description: "ICHRA explained without the jargon: how Individual Coverage Health Reimbursement Arrangements work, who they fit, who they exclude, and what Nevada business owners should check before setting one up."
category: "Guide"
funnelStage: "TOFU"
cluster: "ichra"
...
speakableText: "An ICHRA, or Individual Coverage Health Reimbursement Arrangement, is a federally recognized structure that lets an employer give employees tax-free money to buy individual health insurance plans of their own choosing. The employer controls the budget by setting fixed monthly reimbursement amounts, while each employee selects coverage that fits their own doctors, prescriptions, and household. ICHRAs became available on January 1, 2020, created by a final rule that the Treasury, Labor, and Health and Human Services departments issued together in June 2019. The structure fits some Nevada businesses very well and fits others badly, because eligibility depends on entity type, and owners of certain business structures cannot participate in their own arrangement."
faq:
  - q: "Is an ICHRA legitimate and federally recognized?"
    a: "Yes. ICHRA was created by a final rule issued jointly by the Treasury, Labor, and Health and Human Services departments on June 20, 2019, and the structure became available on January 1, 2020. The governing regulations sit at 26 CFR 54.9802-4, 29 CFR 2590.702-2, and 45 CFR 146.123."
  - q: "Who chooses the health plan under an ICHRA?"
    a: "The employee chooses. Each employee buys the individual plan that fits their own doctors, prescriptions, and family, and the employer reimburses premiums tax-free up to the set allowance. The employee must actually enroll in individual coverage or Medicare to use the arrangement."
  - q: "Is ICHRA reimbursement taxable income?"
    a: "No. ICHRA reimbursements for qualifying premiums are tax-free to the employee and deductible for the employer when the arrangement is administered correctly."
  - q: "Can a business owner participate in the company's own ICHRA?"
    a: "Entity type decides it. C-corp owners are generally treated as employees and can participate. Owners of an S corporation holding more than 2 percent of the stock are treated like partners rather than employees for fringe benefit purposes and generally cannot. Sole proprietors and partners are not employees of their own businesses at all. Entity questions belong in a conversation that includes a tax professional."
  - q: "Does accepting an ICHRA affect premium tax credits?"
    a: "Yes, significantly. An employee who accepts an ICHRA cannot claim a premium tax credit for that coverage. An employee offered an ICHRA that does not meet the affordability standard may opt out and claim a premium tax credit instead, but the choice is one or the other, never both."
relatedQa:
  - "is-an-ichra-legit"
...
1. The employer sets a **fixed monthly allowance** per employee. Allowances can differ by legitimate employee class, such as full-time versus part-time, or salaried versus hourly.
2. Each employee **buys an individual health plan** of their own choosing, through [Nevada Health Link](https://nevadahealthlink.com/get-help/when-to-enroll/) or directly from a carrier, and must actually be enrolled in individual coverage or Medicare to participate.
3. The employer **reimburses premiums tax-free** up to the allowance. Money not claimed is not paid out. It stays with the business.
...
The structure was created by a [final rule issued jointly by the Treasury, Labor, and Health and Human Services departments](https://www.federalregister.gov/documents/2019/06/20/2019-12571/health-reimbursement-arrangements-and-other-account-based-group-health-plans) on June 20, 2019, and became available on January 1, 2020. This is not a workaround or a gray area. The [Internal Revenue Service publishes guidance on health reimbursement arrangements](https://www.irs.gov/newsroom/health-reimbursement-arrangements-hras) directly, and the operative regulations sit at 26 CFR 54.9802-4, 29 CFR 2590.702-2, and 45 CFR 146.123. Whether the structure is real is answered in more detail in [is an ICHRA legit](/qa/is-an-ichra-legit).

### What can an ICHRA reimburse?

Individual health insurance premiums are the primary use. Depending on how the plan document is written, an ICHRA may also reimburse Medicare premiums and out-of-pocket costs such as deductibles and copayments. The [HealthCare.gov employer guidance](https://www.healthcare.gov/small-businesses/learn-more/individual-coverage-hra/) covers the permitted categories, and the Medicare question specifically is covered in [can an ICHRA reimburse Medicare premiums](/qa/can-an-ichra-reimburse-medicare-premiums).

What it cannot do is reimburse a plan that is not individual coverage. Short-term medical, healthcare sharing ministries, and fixed-indemnity products do not satisfy the integration requirement, and an employee covered only by one of those is not eligible to use the arrangement. The month-to-month mechanics of claiming are covered in [how does ICHRA reimbursement work](/qa/how-does-ichra-reimbursement-work).
...
**A genuinely mixed workforce.** Employees whose spouses already carry family coverage get little value from a group plan they will never use. An ICHRA lets those employees decline without the business paying for an empty seat, and what happens when someone declines is covered in [can an employee decline an ICHRA](/qa/can-an-employee-decline-an-ichra).
...
An employee who is **offered** an ICHRA that does not meet the affordability standard may opt out and claim a premium tax credit instead. Per the [HealthCare.gov guidance for employees](https://www.healthcare.gov/job-based-help/ichra/), the credit becomes available only when the offer fails affordability and the employee declines it. It is one or the other, never both, which is unpacked further in [does an ICHRA affect premium tax credits](/qa/does-an-ichra-affect-premium-tax-credits).
...
Running that comparison person by person, before the arrangement is announced, is the difference between a benefit people thank you for and one that quietly costs them money. The [IRS explains how the premium tax credit is calculated](https://www.irs.gov/affordable-care-act/individuals-and-families/the-premium-tax-credit-the-basics), and the estimate gets reconciled at tax time, which is why the income projection matters as much as the plan choice. In a Clark County workforce where tipped and commission income swings month to month, that projection is genuinely hard to get right.
...
The S corporation rule catches the most people, because it feels backwards to an owner who takes a W-2 salary from their own company. IRS guidance on [S corporation compensation and medical insurance issues](https://www.irs.gov/businesses/small-businesses-self-employed/s-corporation-compensation-and-medical-insurance-issues) and [Publication 15-B on fringe benefits](https://www.irs.gov/publications/p15b) explain the treatment: a shareholder owning more than 2 percent of the stock is treated as a partner rather than an employee for fringe benefit purposes.

That does not mean an S corporation owner has no options. It means the ICHRA is for the team, and the owner's own coverage gets solved separately, often through the self-employed health insurance deduction. The specifics live in [can an S-corp owner use an ICHRA](/qa/can-an-s-corp-owner-use-an-ichra) and in [tax-advantaged health benefits for the self-employed](/blog-post/tax-advantaged-health-benefits-self-employed).
...
**Send the notice on time.** Current employees must receive written notice at least 90 days before the start of the plan year, and new employees get it when they become eligible. The Labor Department publishes a [model ICHRA notice](https://www.dol.gov/agencies/ebsa/laws-and-regulations/rules-and-regulations/completed-rulemaking/1210-ab87/individual-coverage-model-notice) that can be adapted. Miss the notice window and the plan year start moves.

**Help employees enroll.** Nevada open enrollment runs November 1 through December 31, a window federal rules shortened beginning with the 2027 plan year. An ICHRA offer also opens a special enrollment period for affected employees. Timing the announcement against that calendar is the difference between smooth adoption and a scramble, and the dates are laid out in [when is open enrollment in Nevada](/qa/when-is-open-enrollment-in-nevada).
...
**Verify the producer.** Anyone advising on this in Nevada should hold an active producer license, and any Nevadan can check one through the [Nevada Division of Insurance](https://doi.nv.gov/).
...
What happens to the arrangement when someone leaves is worth understanding before you start, and that is covered in [what happens to my ICHRA if I leave my job](/qa/what-happens-to-my-ichra-if-i-leave-my-job).
