---
question: "Do You Have To Sign Up For Medicare At 65?"
description: "Whether Medicare enrollment at 65 is mandatory, who gets enrolled automatically, who must act, and the one exception that lets people delay without penalty."
cluster: "medicare"
...
quickAnswer: "Not always, but the default answer is yes. Enrolling during the 7-month Initial Enrollment Period avoids a lifetime Part B penalty. The main exception is qualifying employer coverage from active employment at a company with 20 or more employees."
speakableText: "Medicare enrollment at 65 is not legally mandatory, but skipping it usually carries a permanent cost. The Initial Enrollment Period lasts 7 months, covering the 3 months before the 65th birthday month, the birthday month, and the 3 months after. Missing that window without qualifying coverage adds 10 percent to the Part B premium for every full 12-month delay, for life. People with qualifying coverage from active employment at an employer with 20 or more employees can delay safely and enroll later through a Special Enrollment Period."
faq:
  - q: "Is Medicare enrollment automatic at 65?"
    a: "Only for people already receiving Social Security benefits, who are enrolled in Parts A and B automatically. Everyone else must actively sign up through Social Security."
  - q: "What happens if someone skips Medicare at 65 with no other coverage?"
    a: "The Part B late penalty adds 10% to the monthly premium for each full 12-month period of delay, and the penalty lasts for life. Part D carries a separate permanent penalty."
  - q: "Does COBRA count as coverage that allows delaying Medicare?"
    a: "No. COBRA and retiree coverage do not count as qualifying coverage, and relying on them past 65 can trigger the lifetime Part B penalty."
  - q: "When does the Initial Enrollment Period start and end?"
