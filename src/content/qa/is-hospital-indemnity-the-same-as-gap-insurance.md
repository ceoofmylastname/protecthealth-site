...
faq:
  - q: "What does a hospital indemnity policy pay for?"
    a: "Defined cash amounts for hospital admission and often per inpatient day, sometimes with add-ons for ICU stays or ambulance transport. The benefit is fixed by the policy, regardless of the hospital bill."
  - q: "Is accident insurance also a form of GAP coverage?"
    a: "Yes, in strategy terms. Accident policies pay defined benefits after covered injuries, and many GAP-style packages combine accident and hospital indemnity triggers to cover more of the deductible-exposure scenarios."
  - q: "Can hospital indemnity replace health insurance?"
    a: "No. Hospital indemnity pays fixed cash amounts for defined events and provides none of the comprehensive protections of major medical coverage. The design assumes a real health plan underneath."
  - q: "Why do the terms get used interchangeably?"
    a: "Because hospital indemnity is the most common engine inside GAP-strategy packages. Sellers and shoppers often use GAP as the goal and hospital indemnity as the product achieving it."
---

The relationship is genus and species: GAP is the strategy, hospital indemnity is the most common product built to execute it.

## How do the two terms actually relate?

| | GAP insurance | Hospital indemnity |
|---|---|---|
| What it names | A supplemental strategy: cash benefits aimed at deductible exposure | A specific policy design |
| Triggers | Accidents, hospital stays, ambulance, sometimes critical illness | Hospital admission and inpatient days |
...
The evaluation is exposure-matching, not label-shopping. A household's deductible risk comes from somewhere: active kids and physical work point toward accident triggers, age and health history point toward admission triggers, and most households near a high deductible benefit from both in one package. The constant across every design: these are supplements riding on top of a major medical plan. Any pitch positioning hospital indemnity or GAP coverage *instead of* real health insurance is pitching the wrong product.
