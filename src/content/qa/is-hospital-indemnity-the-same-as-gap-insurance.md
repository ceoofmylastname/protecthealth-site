...
description: "Hospital indemnity pays fixed amounts tied to admissions and inpatient days. GAP is a looser marketing label for supplements aimed at deductible and cost-sharing exposure."
cluster: "nevada-core"
...
faq:
  - q: "What does a hospital indemnity policy pay on?"
    a: "Defined cash amounts tied to hospital admission and often to each inpatient day, sometimes with additional amounts for intensive care or ambulance transport. Payment is fixed by the contract regardless of the hospital charge."
  - q: "Is accident coverage part of the same category?"
    a: "In practice yes, as another event-triggered supplement. Accident policies pay defined amounts after covered injuries, and several packages combine accident and admission triggers in one contract."
  - q: "Can hospital indemnity coverage replace a health plan?"
    a: "No. Hospital indemnity pays fixed amounts on defined events, carries no provider network, and provides none of the protections an ACA-compliant plan carries. The design assumes real coverage underneath."
  - q: "Why are the two terms used interchangeably?"
    a: "Because product names in this category are not standardized and an admission trigger sits at the center of many supplements marketed as deductible offsets. Contract language is what distinguishes them."
  - q: "Which document settles what a policy actually pays?"
    a: "The schedule of benefits inside the policy, which lists every triggering event, the amount payable for each, any waiting period, and the frequency limits. Brochures are not contracts."
---
...
| | Hospital indemnity | Supplements marketed as GAP |
|---|---|---|
| What the term names | A contract structure | A goal, applied loosely to several structures |
| Typical triggers | Admission, inpatient days, sometimes intensive care | Admission plus accident, ambulance, outpatient surgery, sometimes a listed critical illness |
| Payment basis | Fixed amounts written into the schedule | Fixed amounts written into the schedule |
| Reads the medical bill | No | No |
| Replaces major medical coverage | Never | Never |
...
This is not a reason to distrust the category. It is a reason to ignore the name and read the schedule of benefits, which lists every triggering event, the amount payable for each, any waiting period, and the frequency limits. General consumer background on how health coverage is structured is published by the [National Association of Insurance Commissioners](https://content.naic.org/consumer/health-insurance.htm), and product-specific questions belong with the [Nevada Division of Insurance](https://doi.nv.gov/), which regulates insurance products in the state and licenses the producers selling them.
...
Honest framing beats enthusiasm here. These products are frequently oversold, and for many Clark County households a lower-deductible plan or a funded health savings account solves the same liquidity problem with fewer conditions attached. We are insurance nerds, not tax professionals, so the tax treatment of a health savings account belongs with a licensed tax professional. The service overview sits at [GAP health insurance](/services/gap-health-insurance), and a household that wants both contracts compared side by side, including the outcome where neither gets bought, can [talk to a broker](/talk-to-a-broker).
