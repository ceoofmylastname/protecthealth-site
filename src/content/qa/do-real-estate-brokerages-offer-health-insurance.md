...
description: "Why most brokerages cannot put 1099 agents on group health plans, what some offer instead, and the coverage paths that actually work for agents."
cluster: "ichra"
...
faq:
  ...
  - q: "Do any brokerages provide health benefits at all?"
    a: "Some large brokerages promote association plans, private marketplaces, or discount programs for agents. These are access points rather than employer-paid group benefits, and terms deserve close comparison."
  - q: "Can a brokerage's W-2 staff get group coverage while agents cannot?"
    a: "Yes. A brokerage that employs W-2 staff may sponsor a small-group plan for those employees, while commission agents at the same office still need individual coverage strategies."
  - q: "What should an agent do instead of waiting on the brokerage?"
    a: "Most agents combine a marketplace plan with premium tax credits calculated on net commission income, then evaluate structure-dependent options based on business structure, income, and household situation."
---

New agents ask this at orientation; veterans stopped asking years ago. The answer explains a lot about why health coverage is the sore spot of the entire industry.
