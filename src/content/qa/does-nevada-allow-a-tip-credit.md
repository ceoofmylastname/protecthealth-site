...
faq:
  ...
  - q: "What must Las Vegas employers pay tipped employees?"
    a: "The full Nevada state minimum wage in direct wages, every hour, before tips. Tips belong to the employee on top of that wage, never in place of any part of it."
  - q: "What happens if a business has been using tip-credit math in Nevada?"
    a: "Every affected paycheck creates back-wage liability, and the exposure compounds each pay period the setup runs. Correcting the wage structure immediately and assessing the lookback is the move."
  - q: "Does Nevada's rule change federal tip taxes or the FICA tip credit?"
    a: "No. Tip reporting, payroll taxes on tips, and the federal FICA tip credit all operate the same way in Nevada. The state rule only governs the wage floor."
---
...
Full state minimum wage, every hour, before the first tip:

| | Federal tip-credit model | Nevada |
|---|---|---|
| Direct cash wage | As low as $2.13/hr | Full state minimum wage |
| Tips count toward minimum? | Yes | Never |
| Tips belong to | Employee (after valid pooling) | Employee (after valid pooling) |

Tips remain the employee's on top of the wage, subject only to [valid tip pooling rules](/qa/who-can-legally-share-a-tip-pool).
