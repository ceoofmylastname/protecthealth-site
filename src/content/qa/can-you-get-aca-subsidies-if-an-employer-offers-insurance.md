---
question: "Can You Get ACA Subsidies If An Employer Offers Insurance?"
description: "An affordable employer offer blocks ACA premium tax credits for that person, even if the offer is declined. How affordability is measured and the family angle."
cluster: "nevada-core"
...
quickAnswer: "Generally no. An employer offer that meets the ACA's affordability and minimum-value standards blocks premium tax credits for that person, even if the offer is declined. Only an unaffordable or substandard offer restores subsidy eligibility."
speakableText: "An offer of employer coverage, not enrollment, the offer itself, is what blocks ACA premium tax credits. When the employee's share of the premium for self-only coverage falls under the ACA's affordability percentage of household income and the plan meets minimum-value standards, that employee cannot take marketplace subsidies, even after declining the offer and buying through Nevada Health Link. An offer that fails the affordability test, or a plan that fails minimum value, restores credit eligibility. Family members' eligibility is tested separately against the cost of family coverage, a fix to the old rule known as the family glitch."
faq:
  - q: "Does declining employer coverage restore subsidy eligibility?"
    a: "No. The offer itself blocks the credit when it meets affordability and minimum-value standards. Declining an affordable offer and buying on the marketplace means paying full price."
  - q: "How is an employer offer's affordability measured?"
    a: "By comparing the employee's cost for self-only coverage against an ACA affordability percentage of household income, a threshold the IRS adjusts periodically. Offers above the threshold fail the test and unlock credits."
  - q: "What was the family glitch?"
    a: "An old rule that tested affordability for the whole family using the cheaper self-only premium, blocking spouses and children from subsidies. Current rules test family members against the actual cost of family coverage."
  - q: "Do ICHRA offers affect subsidy eligibility?"
    a: "Yes. An ICHRA allowance deemed affordable under IRS formulas blocks premium tax credits the same way traditional group coverage does; an unaffordable allowance lets the employee opt out and keep credits."
---
...
Pass both, and the credit is blocked for that employee, enrolled or not. Fail either, and marketplace credits open back up, calculated as described in the [premium tax credit guide](/blog-post/aca-premium-tax-credits-explained).
