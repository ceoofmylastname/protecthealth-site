---
question: "What Happens To An ICHRA After Leaving A Job?"
description: "What happens to an ICHRA after leaving a job: the reimbursement stops, but the individual health plan belongs to the employee and continues without a gap in coverage."
cluster: "ichra"
...
faq:
  - q: "Does health coverage end on the last day of work under an ICHRA?"
    a: "No. The individual policy is owned by the employee and stays in force as long as premiums are paid. Only the employer's reimbursement ends at separation."
  - q: "Do unused ICHRA funds pay out after separation?"
    a: "Generally no. An allowance is a reimbursement promise rather than a funded account balance, so unclaimed amounts stay with the employer."
  - q: "Does losing ICHRA reimbursement open a special enrollment period?"
    a: "Losing employer contributions generally counts as a qualifying event, which opens a window to change plans or apply for a premium tax credit based on the new household income."
  - q: "Can premium tax credits become available after leaving a job with an ICHRA?"
    a: "Often yes. An offer of an ICHRA forecloses the credit for that coverage, so once the offer ends, eligibility depends on the new household income and the rest of the ordinary tests."
  - q: "Is an ICHRA plan more portable than group insurance?"
    a: "Yes. A group plan typically ends with employment and forces a decision about continuation coverage. An ICHRA plan simply continues, and only the funding source changes."
---
...
That portability is a structural difference, not a courtesy from a generous employer. The [HealthCare.gov guidance for employees offered an individual coverage HRA](https://www.healthcare.gov/job-based-help/ichra/) describes the same arrangement from the employee's side, and the wider structure sits in the [plain-English ICHRA guide](/blog-post/what-is-an-ichra).
...
**Compare the options honestly.** The trade-offs between an employer-funded arrangement and a subsidized marketplace plan are laid out in [ICHRA versus marketplace health insurance](/blog-post/ichra-vs-marketplace-health-insurance).
